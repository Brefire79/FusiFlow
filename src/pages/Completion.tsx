...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'netlify',   label: 'Configurar variáveis no Netlify',               desc: 'VITE_FIREBASE_* no painel de ambiente',       fixed: true },
      { id: 'functions', label: 'Fazer deploy das Cloud Functions',              desc: 'Requer plano Blaze — exportação PDF/DOCX' },
      { id: 'icons',     label: 'Executar npm run generate-icons',               desc: 'Gera ícones do PWA',                          fixed: true },
      { id: 'seed',      label: 'Executar npm run seed (opcional)',              desc: 'Popula dados de demonstração' },
      { id: 'build',     label: 'Fazer build e deploy no Netlify',               desc: 'npm run build → drag & drop ou git push',     fixed: true },
    ],
  },
  {
    id: 'postdeploy',
